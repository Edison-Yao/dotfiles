# Mirrors
generate mirrorlist [link](https://www.archlinux.org/mirrorlist/).
...
## Iran
#Server = https://mirrors.mirjamali.ir/archlinux/$repo/os/$arch
## Canada
...
replace the contents of <table><tr><td bgcolor=#E0FFFF>/etc/pacman.d/mirrorlist</td></tr></table>

add archlinuxcn <table><tr><td bgcolor=#E0FFFF>/etc/pacman.conf</td></tr></table>
```
[archlinuxcn]
